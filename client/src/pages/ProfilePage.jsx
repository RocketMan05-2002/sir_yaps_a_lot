...
const ProfilePage = () => {
  ...
  const [name, setName ] = useState("Abhinay Shambharkar");
    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center' >
      ...
      border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg '>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'  >
          ...
          required placeholder='Write profile bio' className='p-2 border border-gray-500 
          rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500'></textarea>
          <button type='submit' className='py-2 bg-gradient-to-r from-purple-400 to-violet-600 text-white text-lg rounded-full cursor-pointer'>Save</button>
        </form>
